...
public class FoodPriceSite {
    ...
    public void start() {
        ...
        while (true) {
                ...
                System.out.println(MenuSearchStore.value);
                System.out.println(MenuSearchRank.value);
...
//                scanner.nextLine(); // Consume newline character
            ...
            try {
                ...
                switch (option) {
                    ...
                    case 2:
                        System.out.println(EnterStoreName.value);
                        try {
                            String input = scanner.nextLine();
                            ...
                            if (!input.equalsIgnoreCase("foodbasics") && !input.equalsIgnoreCase("zehrs") && !input.equalsIgnoreCase("metro")) {
                                System.out.println("Enter a valid store");
                                continue;
                            }
                            if ("exit".equalsIgnoreCase(input.trim())) {
                                System.out.println(Exiting.value);
